...
public interface BankInterface {
    ...
    void removeSavingsAccount(Customer customer, int accountNumber, String password);
    void removeCheckingAccount(Customer customer,int accountNumber , String password);
